...
try:
    from odoo.addons.llm_thread.models.llm_thread import (
        RelatedRecordProxy as _RelatedRecordProxy,
    )
except ImportError:
...
class LLMAssistant(models.Model):
    ...
    # NOTE: structured_chat() moved to the llm_odoo module (the C-layer
    # decision primitive). See llm_odoo/models/llm_assistant.py.
