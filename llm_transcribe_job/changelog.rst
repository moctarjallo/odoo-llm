...
* [INIT] Initial release of LLM Generate Job module (renamed from LLM Transcription Job)
* [ADD] Transcription job lifecycle management (Draft → Queued → Running → Completed/Failed/Cancelled)
* [ADD] Provider-specific queue management with concurrency control
* [ADD] Flexible transcription options (direct vs queued)
...
* [ADD] Provider integration interface with fallback to direct transcription
* [ADD] PostgreSQL advisory locking integration
* [ADD] Security access rights for users and managers
* [FEAT] Backward compatibility with existing transcription system
...
* [REFACTOR] Thread extension now only overrides transcribe_response() method instead of generate()
